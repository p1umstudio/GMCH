...
<body>
 ...
 <div>
         <table>
                    ...
                    <tr id="car_inf">
                        <td id="car_inf">8.2</td>
                        <td id="car_inf">2.3</td>
                        <td id="car_inf">2.8</td>
                        <td id="car_inf">2.1</td>
                        <td id="car_inf">224.91</td>
                ...
                <table id="car_inf_shape">
                    ...
                    <tr>
                        <td id="car_inf">습격 해금가 : $995,000</td>
                        <td id="car_inf">기본가 :  $1,323,350</td>
                    </tr>
                </table>
