        ...
        <?php
         if(isset($_GET['page'])){
          $page = $_GET['page'];
              ...
              $sql = mq("select * from board where $catagory like '%$search_con%' order by b_no desc limit $start_num, $list");
          ...
          $sql2 = mq("select * from board where $catagory like '%$search_con%' order by b_no desc limit $start_num, $list");
