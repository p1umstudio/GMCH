...
if($id && $title && $content){
    $sql = mq("insert into board(id,title,content,date, lock_post,file) values('".$id."','".$title."','".$content."','".$date."','".$lo_post."','".$convert_name."')"); 
    $sql = mq("update member set exp = '".$exp2."' where id = '".$id."'");
    echo "<script>
    alert('글쓰기 완료되었습니다.');
