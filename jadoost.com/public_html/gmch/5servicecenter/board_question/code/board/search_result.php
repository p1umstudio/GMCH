        ...
        <?php
         if(isset($_GET['page'])){
          $page = $_GET['page'];
              ...
              $sql = mq("select * from question_board where $catagory like '%$search_con%' order by question_b_no desc limit $start_num, $list");
          ...
          $sql2 = mq("select * from question_board where $catagory like '%$search_con%' order by question_b_no desc limit $start_num, $list");
    ...
    <tr>
      ...
      <td id="table_left" width="500" colspan="2" ><?php 
        ...
        if($question_board['lock_post']=="1"){ ?>
          <a href='ck_read.php?question_b_no=<?php echo $question_board["question_b_no"];?>'><?php echo $title; ?><span class="re_ct">[<?php echo $rep_count; ?>]</span><? echo $lockimg;
            }else{    
        ...
        <a href='read.php?question_b_no=<?php echo $question_board["question_b_no"]; ?>'><?php echo $title;?><span class="re_ct">[<?php echo $rep_count; ?>]<?php echo $img; ?></span><? }?>
        </a>
        </td>
        </tr>
        <tr>
      ...
      <div id="id_mm-dd_hit">
          ...
          <?php echo $question_board['date']?>&#32; &#124;
          상태 : <?php echo $question_board['state']; ?>
      </div>
      </td>
    </tr>
  </tbody>
