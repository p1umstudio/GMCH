...
('지.만.추(GTA에서 만남을 추구할수있을까?)')은(는)
개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 
보호하고 개인정보와 관련한 이용자의 고충을 
원활하게 처리할 수 있도록 다음과 같은 
처리방침을 두고 있습니다.

('지.만.추(GTA에서 만남을 추구할수있을까?)')은(는) 
회사의 개인정보처리방침을 개정하는 경우 웹사이트 
공지사항(또는 개별공지)을 통하여 공지할 것입니다.

○ 본 방침은부터 2020년 11월 27일부터 시행됩니다.
...
서비스 제공, 콘텐츠 제공 등을 목적으로 
개인정보를 처리합니다.

2. 개인정보 파일 현황

('지.만.추(GTA에서 만남을 추구할수있을까?)')가 
개인정보 보호법 제32조에 따라 등록․공개하는 
개인정보파일의 처리목적은 다음과 같습니다.

1. 개인정보 파일명 : u567191728_gmch.db
개인정보 항목 : 이메일, 비밀번호, 로그인ID, 성별, 이름, 쿠키
수집방법 : 홈페이지
보유근거 : 회원 식별을 위한 확인
보유기간 : 10년
...
1. <송인창>
개인정보를 제공받는 자 : 송인창
제공받는 자의 개인정보 이용목적 : 이메일, 비밀번호, 로그인ID, 성별, 이름
제공받는 자의 보유.이용기간: 10년
...
위탁기간 : 10년
② ('지.만.추(GTA에서 만남을 추구할수있을까?)')은(는) 
위탁계약 체결시 개인정보 보호법 제25조에 따라 위탁업무 
수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 
재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 
...
6. 정보주체와 법정대리인의 권리·의무 및 
행사방법 이용자는 개인정보주체로써 
다음과 같은 권리를 행사할 수 있습니다.

① 정보주체는 Plum Studio에 대해 언제든지 개인정보 정정, 
삭제, 처리정지 요구 등의 권리를 행사할 수 있습니다.

② 제1항에 따른 권리 행사는Plum Studio에 대해 
개인정보 보호법 시행령 제41조제1항에 따라 서면, 전자우편, 
모사전송(FAX) 등을 통하여 하실 수 있으며 Plum Studio은(는) 
이에 대해 지체 없이 조치하겠습니다.
...
⑥ Plum Studio은(는) 정보주체 권리에 따른 열람의 요구, 
...
별도의 DB에 옮겨져(종이의 경우 별도의 서류)
내부 방침 및 기타 관련 법령에 따라 
...
① Plum Studio 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 
...
쿠키 저장을 거부 할 수 있습니다. 다. 쿠키 저장을 거부할 경우 
맞춤형 서비스 이용에 어려움이 발생할 수 있습니다.

10. 개인정보 보호책임자 작성

① Plum Studio(‘지.만.추(GTA에서 만남을 추구할수있을까?)) 은(는) 
...
직책 :팀장
직급 :팀장
연락처 :01048148603, sanrtr907@gmail.com,
※ 개인정보 보호 담당부서로 연결됩니다.
...
1. 저희 ('지.만.추(GTA에서 만남을 추구할수있을까?)')은(는)
매칭기능의 채팅기능을 서비스로 제공하고 있으나 따로 별도의
로그파일은 보관하고 있지 않습니다. 그에 따른 로그 요구의 조치는
저희가 수행해 드릴수 없습니다.

2. 저희 ('지.만.추(GTA에서 만남을 추구할수있을까?)')은(는)
개인정보 동의는 회원가입을 통해 자동 동의했다고 간주합니다.
